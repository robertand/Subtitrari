...
class Translator:
    ...
    def format_translation_prompt(
        ...
        prompt = (
            f"Ești un traducător profesionist pentru subtitrări. Tradu textul din {source_lang} în {target_lang}.\n\n"
            "REGLI DE AUR:\n"
            "1. INTERZIS traducerea literală cuvânt-cu-cuvânt. Tradu SENSUL, nu cuvintele.\n"
            "2. Expresiile idiomatice trebuie înlocuite cu echivalentul lor natural în limba țintă.\n"
            "3. Înjurăturile și vulgăritățile se traduc cu echivalente naturale, nu literale.\n"
            "   EXEMPLU: \"you son of a bitch\" NU se traduce \"fiu de cățea\", ci \"nemernicule\", \"tâmpitule\", \"javră ordinară\", etc., în funcție de context și ton.\n"
            "4. Dialogul trebuie să sune natural în {target_lang}, ca și cum ar fi fost scris inițial în această limbă.\n"
            "5. Păstrează tonul vorbitorului (formal, informal, agresiv, politicos, etc.).\n"
            "6. Păstrează textul concis. Subtitrările trebuie să poată fi citite rapid de către spectatori; evită frazele lungi sau încărcate inutil în {target_lang}.\n"
            "7. Dacă textul conține taguri de formatare (ex: <i>, </i>, <u>, </u>) sau coduri de timp, lasă-le exact în aceeași poziție, nemodificate.\n"
            "8. NU adăuga explicații, introduceri, paranteze, note sau text suplimentar (ex: NU scrie \"Iată traducerea:\"). Returnează strict și DOAR textul tradus.\n\n"
            f"Textul de tradus:\n{text}\n\n"
            f"Traducerea:"
        )
    ...
    def translate_with_vllm_grouped(
        ...
        try:
            ...
            system_prompt = (
                "Ești un traducător profesionist pentru subtitrări de film/TV. "
                f"Tradu textul din {source_lang} în {target_lang}.\n\n"
                "REGLI DE AUR:\n"
                "1. INTERZIS traducerea literală. Tradu SENSUL, nu cuvintele.\n"
                "2. Expresiile idiomatice → echivalent natural în limba țintă.\n"
                "3. Înjurăturile se tradu natural, NU literal.\n"
                "   EXEMPLU: \"you son of a bitch\" → \"nemernicule\" / \"tâmpitule\" (NU \"fiu de cățea\")\n"
                "   EXEMPLU: \"what the fuck\" → \"ce dracu'\" / \"ce naiba\" (NU \"ce futai\")\n"
                "4. Dialogul trebuie să sune natural, ca și cum ar fi fost scris inițial în {target_lang}.\n"
                "5. Păstrează tonul și stilul vorbitorului (formal, argou, agresiv, politicos).\n"
                "6. ACORD GRAMATICAL: Folosește genul vorbitorului (male/female) pentru acordul corect.\n"
                "7. NU adăuga explicații, note, paranteze sau text suplimentar. DOAR traducerea.\n"
                "8. Returnează rezultatul EXCLUSIV ca JSON sub cheia 'translations'.\n"
                "9. Păstrează exact numărul și ordinea segmentelor.\n"
            )
    ...
    def _call_llm_api(
        ...
        n = len(batch)
        system_prompt = (
            f"You are a professional film/TV subtitle translator. Translate the following segments into {target_lang}.\n"
            "GOLDEN RULES:\n"
            f"- NEVER translate word-for-word. Translate the MEANING naturally into {target_lang}.\n"
            "- Idioms → natural equivalent in target language. NEVER literal.\n"
            "- Swear words → natural equivalents, NOT literal.\n"
            "  EXAMPLE: \"you son of a bitch\" → NOT \"fiu de cățea\" but appropriate intensity equivalent\n"
            "  EXAMPLE: \"what the fuck\" → natural equivalent based on context\n"
            "- Dialogue must sound like it was originally written in {target_lang}.\n"
            "- Preserve the tone and style (formal, slang, aggressive, polite).\n"
            "- Each input line = one subtitle segment. Return translations in the SAME order, one per line.\n"
            "- Do NOT add explanations, notes or extra text.\n"
            "- Sound descriptions like [music], [applause] → keep or translate appropriately.\n"
            f"- Source language: {source_lang}. This is a {content_type}.\n"
        )
